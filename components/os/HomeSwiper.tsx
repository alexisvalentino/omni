...
export default function HomeSwiper({ leftPage, centerPage }: Props) {
  const [currentPage, setCurrentPage] = useState(1); // 0=left, 1=center
  ...
  return (
    ...
    >
      ...
      <motion.div
        drag="x"
        dragConstraints={{ left: -1 * getWidth(), right: 0 }}
        dragElastic={0.15}
